            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reject'])) {
              ...
              if(isset($_POST['selectedRows'])) {
                  ...
                  foreach($_POST['selectedRows'] as $selectedRow) {
                      ...
                      $deleteSql = "DELETE FROM sellcar WHERE sell_ID = '$selectedRow'";
                      
                      // Execute SQL query
                      if (mysqli_query($conn, $deleteSql)) {
                          echo "<script>alert('Row with Rent ID $selectedRow has been rejected and deleted.')</script>";
                      } else {
    ...
    <body>
        ...
        <div class="sidebarAG">
           <img class="nav-adminLogoAG" src="images/Macqueen Wheels.png">
            ...
            <a href="AdminSellCar.php" class="active">
        ...
        <?php
            ...
            $sql = "SELECT s.sell_ID, c.FullName, c.phoneNumber, s.carBrand, s.carModel, s.modelYear, s.kilometer, s.color, s.transmission FROM customer c 
                    INNER JOIN sellcar s ON c.customerID = s.customerID";
            ...
            if (!$result) {
                ...
                echo "<thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td><input type='checkbox' class='rowCheckbox' name='selectedRows[]' value='" . $row['sell_ID'] . "'></td>";
