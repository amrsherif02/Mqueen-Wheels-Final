            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reject'])) {
              ...
              if(isset($_POST['selectedRows'])) {
                  ...
                  foreach($_POST['selectedRows'] as $selectedRow) {
                      ...
                      $deleteSql = "DELETE FROM rent WHERE rentID = '$selectedRow'";
    ...
    <body>
       ...
       <form method="post">
        ...
        <?php
            ...
            $sql = "SELECT r.rentID, c.FullName, c.phoneNumber, c.Email, r.carBrand, r.numOfDay, r.totalPrice FROM customer c 
            ...
            if (!$result) {
                ...
                echo "<thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td><input type='checkbox' class='rowCheckbox' name='selectedRows[]' value='" . $row['rentID'] . "'></td>";
                          echo "<td>" . $row['rentID'] . "</td>";
                          echo "<td>" . $row['FullName'] . "</td>";
                          echo "<td>" . $row['phoneNumber'] . "</td>";
                          echo "<td>" . $row['Email'] . "</td>";
                          echo "<td>" . $row['carBrand'] . "</td>";
                          echo "<td>" . $row['numOfDay'] . "</td>";
